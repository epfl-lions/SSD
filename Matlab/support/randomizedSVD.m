...
%   right now, not using 'opts' for anything, so just ignore it
%
%   X can either be a m x n matrix, or it can be a cell array
%       of the form {@(y)X*y, @(y)X'*y, n }
%
% Follows the algorithm by Tropp et al. in "Structure in randomness..." paper
% Copied from RandomizedEIG.m March 20 2013, Stephen Becker
...
% DOUBLE_QR   = setOpts( 'doubleQR', false );
